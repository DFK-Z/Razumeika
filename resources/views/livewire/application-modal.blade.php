        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-auto">
                ...
                @if($selectedLawyerName)
                    <div class="px-6 py-2 bg-blue-50 text-orange-700 rounded mb-4">
                ...
                <form wire:submit.prevent="submit" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" wire:model.lazy="form.phone"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-400 focus:ring-orange-400 sm:text-sm"
