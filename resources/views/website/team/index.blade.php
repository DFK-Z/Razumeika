    ...
    <section class="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="text-center mb-16">
                <h1 class="text-5xl font-bold text-gray-900 mb-4">Наши учителя</h1>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Специалисты с многолетним опытом</p>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col h-full">
                    ...
                    <div class="p-8 flex-grow">
                        <div class="flex items-center mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-orange-500 font-medium mt-1">{{ $lawyer->specialization }}</p>
                            </div>
                        </div>
                    ...
                    <div class="px-8 pb-8">
                        <a href="{{ route('team.person', $lawyer->id) }}"
                            class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-orange-400 hover:bg-orange-500 transition-colors duration-200 shadow-sm">
                            Подробнее
