...
<section aria-labelledby="intro-title" aria-describedby="intro-description"
    ...
    <div class="grid w-full px-6 py-9 grid-cols-1 gap-4 md:grid-cols-3 pb-12 md:pb-[100px]">
        <div class="grid col-span-1 gap-y-6 md:col-span-2">
            ...
            <div class="text-[16px] sm:text-2xl font-bold text-white bg-orange-400/50 max-w-135">
                <p id="intro-description">{{$inroDescription}}</p>
            </div>
            <ul class="flex gap-4">
                <li class="inline-flex">
                    <div
                        class="bg-orange-400 flex items-center gap-3 text-center text-orange-100 rounded-full px-[30px] py-[12px] border border-orange-300 font-semibold cursor-pointer">
                        <livewire:modal-trigger />
                        <span class="w-[20px] h-[20px] rounded-full bg-orange-400 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" class="text-orange-100 size-3">
    ...
    <div class="bg-orange-400 py-[32px]">
        <div class="flex justify-evenly items-center gap-5 md:grid-cols-4 md:gap-[120px] text-orange-100">
